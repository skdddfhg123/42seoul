...
/*   Updated: 2022/04/21 23:30:11 by idongmin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/philo.h"

static void	flow_time(t_philo *philo, time_t time)
{
	time_t	start_time;
...
static void	main_flow(t_philo *philo)
{
	...
	flow_time(philo, philo->data->eat_t);
...
static void	*routine(void *argv)
{
	...
	while (!philo->data->is_fin)
	{
		...
		flow_time(philo, philo->data->sleep_t);
